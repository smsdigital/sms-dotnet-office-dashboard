...
namespace DataCollector.Auth
{
    class GoogleAuthenticator
    {
        ...
        public static AnalyticsReportingService AuthenticateByAPIKey(string APIKey)
        {
            try
            {
        ...
        /// <returns></returns>
        public static AnalyticsReportingService AuthenticateByOAuth2(string jsonPath, string userName, string[] scopes)
        {
            try
            {
        ...
        /// <returns>An AnalyticsReportingService object able to request data against the Analytics Reporting API.</returns>
        public static AnalyticsReportingService AuthenticateByServiceAccount(string email, string credentialFilePath, string[] scopes)
        {
            try
            {
